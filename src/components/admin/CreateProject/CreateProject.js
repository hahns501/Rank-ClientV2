...
const CreateProject = ({setAddProject}) => {
    ...
    const renderSteps = (step) => {
        switch(step) {
            ...
            case 1:
                return <Step2 projectForm={projectForm} setProjectForm={setProjectForm}/>
            case 2:
                return <Step3 projectForm={projectForm} setProjectForm={setProjectForm}/>
            case 3:
                return <Step4 projectForm={projectForm} setProjectForm={setProjectForm}/>
            case 4:
