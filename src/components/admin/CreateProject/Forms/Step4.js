...
function createData(RubricId, Name){
    return {
        RubricId,
        Name,
    }
...
const rows = [
    createData(1, 'Rubric 1'),
    createData(2, 'Rubric 2'),
    createData(3, 'Rubric 3'),
    createData(4, 'Rubric 4'),
    createData(5, 'Rubric 5'),
]
...
const Step4 = ({projectForm, setProjectForm, rows}) => {
    ...
    const handleSelectAllClick = (event) => {
        ...
        setSelected([]);
        setProjectForm({...projectForm, RubricID:[]})
    };
    ...
    const handleClick = (event, name) => {
        ...
        setProjectForm({...projectForm, RubricID:newSelected})
    };
